...
# creates table of hours and percentages for a given input vector x
...
frissColorSort <- function(vector){
  ...
  frissColors <- c('GREEN','ORANGE','RED','BLACK')
